package com.cms.controller.${packageName}.${objectNameLower};
...
import com.cms.util.AppUtil;
import com.cms.util.ObjectExcelView;
import com.cms.util.Const;
import com.cms.util.PageData;
import com.cms.util.Tools;
import com.cms.util.Jurisdiction;
import com.cms.service.${packageName}.${objectNameLower}.${objectName}Service;
...
public class ${objectName}Controller extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(myLogger, "新增${objectName}");
...
<#list fieldList as var>
	...
	public void delete(PrintWriter out){
		logBefore(myLogger, "删除${objectName}");
	...
	public ModelAndView edit() throws Exception{
		logBefore(myLogger, "修改${objectName}");
	...
	public ModelAndView list(Page page){
		logBefore(myLogger, "列表${objectName}");
	...
	public ModelAndView goAdd(){
		logBefore(myLogger, "去新增${objectName}页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public ModelAndView goEdit(){
		logBefore(myLogger, "去修改${objectName}页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public Object deleteAll() {
		logBefore(myLogger, "批量删除${objectName}");
	...
	public ModelAndView exportExcel(){
		logBefore(myLogger, "导出${objectName}到excel");
