...
<form action="${payUrl}" method="post" id="batchForm">
    ...
    <input type="hidden" name="callbackUrl"
           value="${payOrderInfo.callbackUrl}"/><br />
